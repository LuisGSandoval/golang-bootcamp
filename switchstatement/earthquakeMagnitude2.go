...
// EarthquakeMagnitude2 is a test function
func EarthquakeMagnitude2() {
	if len(os.Args) < 2 {
		fmt.Println("Tell me the magnitude of the earthquake in human terms.. i.e. : mino, great, etc. ")
		return
	}
	richter := os.Args[1]
	...
	switch richter {
	case "massive":
		fmt.Printf("%s's richter scale is 10.0 or more \n", richter)

	case "great":
		fmt.Printf("%s's richter scale is 8.0 to less than 10.0 \n", richter)

	case "major":
		fmt.Printf("%s's richter scale is 7.0 to less than 8.0 \n", richter)

	case "strong":
		fmt.Printf("%s's richter scale is 6.0 to less than 7.0  \n", richter)

	case "moderate":
		fmt.Printf("%s's richter scale is 5.0 to less than 6.0 \n", richter)

	case "light":
		fmt.Printf("%s's richter scale is 4.0 to less than 5.0 \n", richter)

	case "minor":
		fmt.Printf("%s's richter scale is 3.0 to less than 4.0 \n", richter)

	case "very minor":
		fmt.Printf("%s's richter scale is 2.0 to less than 3.0 \n", richter)
